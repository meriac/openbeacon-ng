...
extern void tracker_cmd(int cmd, uint16_t rx_cmd_counter, uint32_t param0, uint32_t param1);
extern void tracker_receive(uint32_t uid, int8_t tx_power, int8_t rx_power, uint32_t epoch);
